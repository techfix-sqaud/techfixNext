...
//   });
//   return (
//     <div className="cart border p-4 shadow-lg w-full h-full overflow-y-scroll dark:shadow-lg dark:bg-boxdark">
...
//                   </button>
//                 </td>
//                 <td>{(item.cost + item.labor).toFixed(2)}</td>
//                 <td>{((item.cost + item.labor) * item.quantity).toFixed(2)}</td>
//                 <td onClick={() => handleOnDelete(index)}>
//                   <BsFillTrashFill />
//                 </td>
//               </tr>
//             ))}
...
//             {successMessageForList && (
//               <tr>
//                 <td colSpan={5} className="text-green-500">
//                   {successMessageForList}
//                 </td>
//               </tr>
//             )}
...
//           <div className="total flex flex-col items-right mt-4">
//             <p>Subtotal: ${subTotal.toFixed(2)}</p>
//             <p>Tax: ${totalTaxAmount.toFixed(2)}</p>
//             <p>Total: ${totalInvoiceAmount.toFixed(2)}</p>
...
import { BsFillTrashFill } from "react-icons/bs";
import barcode from "../UI/Assets/barcode.png";
interface CartItem {
  id: number;
  productName: string;
  cost: number;
