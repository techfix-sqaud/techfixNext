            ...
            <div className="py-12 md:py-20">
              ...
              <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
                <h2 className="h2 mb-4">
                  Unlocking the mysteries of device care.
                </h2>
              </div>
              <div
              ...
              >
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 text-center">
                    Accidentally dropped your phone in water? Don&apos;t worry!
                    Our specialized water damage repair service can rescue your
                    device. We use advanced techniques to diagnose and repair
                    water-damaged phones, bringing them back to life.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 text-center">
                    ...
                    Whether you have a cracked screen or an unresponsive touch,
                    our experts can fix it within minutes. Enjoy a seamless
                    repair experience and get back to using your phone without
                    any hassle.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 text-center">
                    Is your phone&apos;s battery draining too quickly? We
                    provide quick and affordable battery replacement services to
                    ensure your phone lasts all day. Our high-quality batteries
                    are guaranteed to improve your device&apos;s performance and
                    longevity.
                  </p>
                </div>
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 text-center">
                    ...
                    service is here to help. We can fix loose or damaged
                    charging ports, ensuring your phone charges correctly and
                    efficiently. Say goodbye to the frustration of a
                ...
                >
                  ...
                  <p className="text-lg text-gray-400 text-center">
                    ...
                    performance, crashes, or unresponsive apps? Our experts
                    provide comprehensive software troubleshooting to resolve
                    any problems and optimize your phone&apos;s performance.
                  </p>
                </div>
              </div>
            </div>
